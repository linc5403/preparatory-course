...
|        | [[https://github.com/Sunxiao1995/learn/blob/master/sx%202020.03.14.md][学习笔记]]：记录的内容很多需要多加练习和理解哈； ~1.Linux 文件属性~ 里面的表格好像github没有能正确解析； 文件名里面也不要有空格 ~sx 2020.03.14.md~ 可以用 ~-~ 或是 ~_~ 来间接前后单词 |
